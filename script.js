...
function vereficarBandera(elemento){
    ...
    if(elemento.value == 'banderaGua'){
        insertaBanderas.innerHTML = `<article id="ejercicio1">
    ...
    }else if(elemento.value == 'banderaIndia'){
        insertaBanderas.innerHTML = `<article id="ejercicio2">
    ...
    }else if(elemento.value == 'banderaba'){
        insertaBanderas.innerHTML = `<article id="ejercicio3">
    ...
    }else if(elemento.value == 'banderaSue'){
        insertaBanderas.innerHTML = ` <article id="ejercicio4">
        ...
        insertaBanderas.innerHTML = ` <article id="ejercicio5">
